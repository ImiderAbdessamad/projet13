...
public interface PaimentCollaboratorCollaboratorService {
    ...
    PaimentCollaborator transfer(PaimentCollaborator t);
    ...
    String uploadFile(String checksumOld, String tempUpladedFile, String destinationFilePath) throws Exception;
