...
@Service
public class RemoteRepoInfoCollaboratorServiceImpl implements RemoteRepoInfoCollaboratorService {


    public ProcessResult validateGitInfo(RemoteRepoInfo remoteRepoInfo) {
        return gitHubValidationService.validateRepoInfo(remoteRepoInfo);
    }
    ...
    public List<RemoteRepoInfo> findByCollaboratorId(){
    ...
    public RemoteRepoInfo create(RemoteRepoInfo t) {
        ...
        if (loaded == null) {
            t.setRemoteRepoType(remoteRepoTypeService.findOrSave(t.getRemoteRepoType()));
            saved = dao.save(t);
        }else {
            saved = null;
        }
    ...
    @Autowired
    private RemoteRepoTypeCollaboratorService remoteRepoTypeService ;
    @Autowired
    private GitHubValidationService gitHubValidationService;

    public RemoteRepoInfoCollaboratorServiceImpl(RemoteRepoInfoDao dao) {
        this.dao = dao;
    }
