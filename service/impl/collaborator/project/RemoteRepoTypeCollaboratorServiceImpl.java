...
import java.util.List;
@Service
public class RemoteRepoTypeCollaboratorServiceImpl implements RemoteRepoTypeCollaboratorService {
    ...
    public RemoteRepoTypeCollaboratorServiceImpl(RemoteRepoTypeDao dao) {
        this.dao = dao;
    }
