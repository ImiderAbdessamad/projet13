...
public class ProjectDetailCollaboratorServiceImpl implements ProjectDetailCollaboratorService {
    ...
    public ProjectDetail create(ProjectDetail t) {
        ...
        ProjectDetail saved;
        if (loaded == null) {
            t.setProjectTechnology(projectTechnologyService.findByReferenceEntity(t.getProjectTechnology()));
            if (t.getProjectTechnologyProfile() != null)
             t.setProjectTechnologyProfile(projectTechnologyProfileService.findByCode(t.getProjectTechnologyProfile()));
            t.setTitle(t.getProject().getTitle());
            t.setPortDev(t.getPort());
            t.setPortProd(t.getPort());
            t.setPortTest(t.getPort());
            saved = dao.save(t);
        }else {
            saved = null;
        }
    ...
    @Autowired
    private ProjectTechnologyTypeCollaboratorService projectTechnologyTypeCollaboratorService;
