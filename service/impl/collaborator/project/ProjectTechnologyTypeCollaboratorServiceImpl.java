...
import java.util.List;
@Service
public class ProjectTechnologyTypeCollaboratorServiceImpl implements ProjectTechnologyTypeCollaboratorService {
    ...
    @Override
    public ProjectTechnologyType findByCode(ProjectTechnologyType projectTechnologyType) {
        return dao.findByCode(projectTechnologyType.getCode());
    }


    public ProjectTechnologyTypeCollaboratorServiceImpl(ProjectTechnologyTypeDao dao) {
        this.dao = dao;
    }
