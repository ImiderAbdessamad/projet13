...
import ma.zs.zyn.service.facade.collaborator.coupon.InfluenceurCollaboratorService ;
import ma.zs.zyn.bean.core.coupon.Influenceur ;
import ma.zs.zyn.service.facade.collaborator.coupon.CouponStateCollaboratorService ;
import ma.zs.zyn.bean.core.coupon.CouponState ;

import java.util.List;
@Service
public class CouponCollaboratorServiceImpl implements CouponCollaboratorService {
    ...
    public List<Coupon> findByInfluenceurId(Long id){
        return dao.findByInfluenceurId(id);
    }
    public int deleteByInfluenceurId(Long id){
        return dao.deleteByInfluenceurId(id);
    }
    public long countByInfluenceurId(Long id){
        return dao.countByInfluenceurId(id);
    }
    ...
    @Autowired
    private InfluenceurCollaboratorService influenceurService ;
    @Autowired
    private CouponStateCollaboratorService couponStateService ;

    public CouponCollaboratorServiceImpl(CouponDao dao) {
        this.dao = dao;
    }
