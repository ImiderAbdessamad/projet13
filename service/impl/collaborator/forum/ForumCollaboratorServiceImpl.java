package ma.zs.zyn.service.impl.collaborator.forum;
...
import ma.zs.zyn.service.facade.collaborator.forum.ForumCollaboratorService;
...
import ma.zs.zyn.service.facade.collaborator.forum.ForumSubjectCollaboratorService ;
import ma.zs.zyn.bean.core.forum.ForumSubject ;
import ma.zs.zyn.service.facade.collaborator.forum.ForumStateCollaboratorService ;
import ma.zs.zyn.bean.core.forum.ForumState ;
import ma.zs.zyn.service.facade.collaborator.forum.ForumCommentCollaboratorService ;
import ma.zs.zyn.bean.core.forum.ForumComment ;

import java.util.List;
@Service
public class ForumCollaboratorServiceImpl implements ForumCollaboratorService {
    ...
    @Autowired
    private ForumSubjectCollaboratorService forumSubjectService ;
    @Autowired
    private ForumStateCollaboratorService forumStateService ;
    @Autowired
    private ForumCommentCollaboratorService forumCommentService ;

    public ForumCollaboratorServiceImpl(ForumDao dao) {
        this.dao = dao;
    }
