...
import java.util.List;
@Service
public class ForumSubjectCollaboratorServiceImpl implements ForumSubjectCollaboratorService {
    ...
    public ForumSubjectCollaboratorServiceImpl(ForumSubjectDao dao) {
        this.dao = dao;
    }
