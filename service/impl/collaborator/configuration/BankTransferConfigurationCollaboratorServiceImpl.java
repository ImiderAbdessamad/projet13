package ma.zs.zyn.service.impl.collaborator.configuration;
...
@Service
public class BankTransferConfigurationCollaboratorServiceImpl implements BankTransferConfigurationCollaboratorService {
    ...
    public BankTransferConfigurationCollaboratorServiceImpl(BankTransferConfigurationDao dao) {
        this.dao = dao;
    }
