...
import ma.zs.zyn.dao.specification.core.collaborator.CountrySpecification;
...
import java.util.List;
@Service
public class CountryCollaboratorServiceImpl implements CountryCollaboratorService {
    ...
    @Override
    public Country findByLibelle(String libelle) {
        return dao.findByLibelle(libelle);
    }


    public CountryCollaboratorServiceImpl(CountryDao dao) {
        this.dao = dao;
    }
