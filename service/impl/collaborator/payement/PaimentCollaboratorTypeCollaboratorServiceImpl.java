...
@Service
public class PaimentCollaboratorTypeCollaboratorServiceImpl implements PaimentCollaboratorTypeCollaboratorService {
    ...
    public PaimentCollaboratorType findByCode(String code) {
    ...
    public PaimentCollaboratorTypeCollaboratorServiceImpl(PaimentCollaboratorTypeDao dao) {
        this.dao = dao;
    }
