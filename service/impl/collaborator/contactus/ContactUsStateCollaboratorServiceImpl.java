...
import java.util.List;
@Service
public class ContactUsStateCollaboratorServiceImpl implements ContactUsStateCollaboratorService {
    ...
    public ContactUsStateCollaboratorServiceImpl(ContactUsStateDao dao) {
        this.dao = dao;
    }
