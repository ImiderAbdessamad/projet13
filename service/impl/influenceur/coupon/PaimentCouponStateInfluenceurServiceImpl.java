...
import ma.zs.zyn.service.facade.influenceur.coupon.PaimentCouponStateInfluenceurService;
...
import java.util.List;
@Service
public class PaimentCouponStateInfluenceurServiceImpl implements PaimentCouponStateInfluenceurService {
    ...
    @Override
    public PaimentCouponState findByCode(String code) {
        return dao.findByCode(code);
    }


    public PaimentCouponStateInfluenceurServiceImpl(PaimentCouponStateDao dao) {
        this.dao = dao;
    }
