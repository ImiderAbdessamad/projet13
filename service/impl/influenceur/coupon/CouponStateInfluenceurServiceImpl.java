...
import java.util.List;
@Service
public class CouponStateInfluenceurServiceImpl implements CouponStateInfluenceurService {
    ...
    @Override
    public CouponState findByCode(String code) {
        return dao.findByCode(code);
    }


    public CouponStateInfluenceurServiceImpl(CouponStateDao dao) {
        this.dao = dao;
    }
