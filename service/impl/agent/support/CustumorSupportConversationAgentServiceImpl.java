...
import ma.zs.zyn.service.facade.agent.support.CustumorSupportConversationCategoryAgentService ;
...
import java.util.List;
@Service
public class CustumorSupportConversationAgentServiceImpl implements CustumorSupportConversationAgentService {
    ...
    @Autowired
    private CustumorSupportConversationCategoryAgentService custumorSupportConversationCategoryService ;
    @Autowired
    private CustumorSupportConversationStateAgentService custumorSupportConversationStateService ;
    @Autowired
    private CustumorSupportConversationMessageAgentService custumorSupportConversationMessageService ;

    public CustumorSupportConversationAgentServiceImpl(CustumorSupportConversationDao dao) {
        this.dao = dao;
    }
