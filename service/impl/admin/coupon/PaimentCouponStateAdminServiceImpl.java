...
import java.util.List;
@Service
public class PaimentCouponStateAdminServiceImpl implements PaimentCouponStateAdminService {
    ...
    public PaimentCouponStateAdminServiceImpl(PaimentCouponStateDao dao) {
        this.dao = dao;
    }
