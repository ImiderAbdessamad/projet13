...
import ma.zs.zyn.service.facade.admin.coupon.InfluenceurAdminService ;
...
public class CouponAdminServiceImpl implements CouponAdminService {
    ...
    public void findOrSaveAssociatedObject(Coupon t){
        if( t != null) {
            ...
            t.setCouponState(couponStateService.findOrSave(t.getCouponState()));
        }
    }
    ...
    @Autowired
    private InfluenceurAdminService influenceurService ;
    @Autowired
    private CouponStateAdminService couponStateService ;
