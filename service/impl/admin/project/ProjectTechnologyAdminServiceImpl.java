...
@Service
public class ProjectTechnologyAdminServiceImpl implements ProjectTechnologyAdminService {
    ...
    public List<ProjectTechnology> findByProjectTechnologyTypeCode(String libelle) {
        return dao.findByProjectTechnologyTypeCode(libelle);
    }
    ...
    @Autowired
    private ProjectTechnologyTypeAdminService projectTechnologyTypeService;

    public ProjectTechnologyAdminServiceImpl(ProjectTechnologyDao dao) {
        this.dao = dao;
    }
