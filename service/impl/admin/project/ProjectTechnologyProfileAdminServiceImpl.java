...
import java.util.List;
@Service
public class ProjectTechnologyProfileAdminServiceImpl implements ProjectTechnologyProfileAdminService {
    ...
    public ProjectTechnologyProfileAdminServiceImpl(ProjectTechnologyProfileDao dao) {
        this.dao = dao;
    }
