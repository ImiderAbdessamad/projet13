package ma.zs.zyn.service.impl.admin.cloud;
...
@Service
public class OffreCloudProviderAdminServiceImpl implements OffreCloudProviderAdminService {
    ...
    @Autowired
    private CloudProviderAdminService cloudProviderService ;

    public OffreCloudProviderAdminServiceImpl(OffreCloudProviderDao dao) {
        this.dao = dao;
    }
