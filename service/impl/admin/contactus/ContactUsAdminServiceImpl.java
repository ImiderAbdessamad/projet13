...
import java.util.List;
@Service
public class ContactUsAdminServiceImpl implements ContactUsAdminService {
    ...
    public void findOrSaveAssociatedObject(ContactUs t){
        if( t != null) {
            t.setContactUsCategory(contactUsCategoryService.findOrSave(t.getContactUsCategory()));
            t.setContactUsState(contactUsStateService.findOrSave(t.getContactUsState()));
        }
    }
    ...
    @Autowired
    private ContactUsCategoryAdminService contactUsCategoryService ;
    @Autowired
    private ContactUsStateAdminService contactUsStateService ;

    public ContactUsAdminServiceImpl(ContactUsDao dao) {
        this.dao = dao;
    }
