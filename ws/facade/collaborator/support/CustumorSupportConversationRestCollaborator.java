...
@RestController
@RequestMapping("/api/collaborator/custumorSupportConversation/")
public class CustumorSupportConversationRestCollaborator {
    ...
    @Autowired private CustumorSupportConversationCollaboratorService service;
    @Autowired private CustumorSupportConversationConverter converter;
