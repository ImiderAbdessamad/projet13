package  ma.zs.zyn.ws.facade.collaborator.forum;
...
@RestController
@RequestMapping("/api/collaborator/forumSubject/")
public class ForumSubjectRestCollaborator {
    ...
    @Autowired private ForumSubjectCollaboratorService service;
    @Autowired private ForumSubjectConverter converter;
