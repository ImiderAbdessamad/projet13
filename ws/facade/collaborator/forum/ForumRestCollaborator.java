...
@RestController
@RequestMapping("/api/collaborator/forum/")
public class ForumRestCollaborator {
    ...
    @Autowired private ForumCollaboratorService service;
    @Autowired private ForumConverter converter;
