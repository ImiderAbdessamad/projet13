...
@RestController
@RequestMapping("/api/collaborator/cloudProvider/")
public class CloudProviderRestCollaborator {
    ...
    @Autowired private CloudProviderCollaboratorService service;
    @Autowired private CloudProviderConverter converter;
