...
@RestController
@RequestMapping("/api/collaborator/city/")
public class CityRestCollaborator {
    ...
    @Autowired private CityCollaboratorService service;
    @Autowired private CityConverter converter;
