...
public class CollaboratorRestCollaborator {
    ...
    @Operation(summary = "Finds a collaborator by username")
    @GetMapping("username/{username}")
    public ResponseEntity<CollaboratorDto> findByUsername(@PathVariable String username) {
        Collaborator t = service.findByUsername(username);
        if (t != null) {
    ...
    @Autowired private CollaboratorCollaboratorService service;
