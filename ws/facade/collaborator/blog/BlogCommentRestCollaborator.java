...
@RestController
@RequestMapping("/api/collaborator/blogComment/")
public class BlogCommentRestCollaborator {
    ...
    public List<BlogCommentDto> findByCollaboratorId(@PathVariable Long id){
    ...
    @Autowired private BlogCommentCollaboratorService service;
    @Autowired private BlogCommentConverter converter;
