package ma.zs.zyn.ws.facade.collaborator.coupon;
...
@RestController
@RequestMapping("/api/collaborator/paimentCoupon/")
public class PaimentCouponRestCollaborator {
    ...
    @Autowired private PaimentCouponCollaboratorService service;
