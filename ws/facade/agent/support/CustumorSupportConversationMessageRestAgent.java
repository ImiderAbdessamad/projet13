...
@RestController
@RequestMapping("/api/agent/custumorSupportConversationMessage/")
public class CustumorSupportConversationMessageRestAgent {
   ...
   public CustumorSupportConversationMessageRestAgent(CustumorSupportConversationMessageAgentService service, CustumorSupportConversationMessageConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CustumorSupportConversationMessageAgentService service;
