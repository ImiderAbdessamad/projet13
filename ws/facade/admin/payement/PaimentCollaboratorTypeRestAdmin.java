...
@RestController
@RequestMapping("/api/admin/paimentCollaboratorType/")
public class PaimentCollaboratorTypeRestAdmin {
    ...
    @Autowired private PaimentCollaboratorTypeAdminService service;
    @Autowired private PaimentCollaboratorTypeConverter converter;
