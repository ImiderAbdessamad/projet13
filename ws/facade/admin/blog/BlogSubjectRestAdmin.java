...
import ma.zs.zyn.service.facade.admin.blog.BlogSubjectAdminService;
...
@RestController
@RequestMapping("/api/admin/blogSubject/")
public class BlogSubjectRestAdmin {
    ...
    @Autowired private BlogSubjectAdminService service;
    @Autowired private BlogSubjectConverter converter;
