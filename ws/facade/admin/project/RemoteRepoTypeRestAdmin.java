...
@RestController
@RequestMapping("/api/admin/remoteRepoType/")
public class RemoteRepoTypeRestAdmin {
    ...
    @Autowired private RemoteRepoTypeAdminService service;
    @Autowired private RemoteRepoTypeConverter converter;
