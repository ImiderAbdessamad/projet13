package ma.zs.zyn.ws.facade.admin.configuration;
...
@RestController
@RequestMapping("/api/admin/bankTransferConfiguration/")
public class BankTransferConfigurationRestAdmin {
    ...
    @Autowired private BankTransferConfigurationAdminService service;
